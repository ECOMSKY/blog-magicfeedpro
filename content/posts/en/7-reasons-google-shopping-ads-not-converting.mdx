...
<FAQ items={[
  {
    q: "How quickly should conversion rate improve after a fix?",
    a: "Title and image fixes typically show measurable lift within 7–10 days as Google relearns the impression signal. Price changes show within 24–48 hours. PMax structural changes need 14 days to exit the learning phase before you can read the data."
  },
  {
    q: "Should I pause underperforming SKUs?",
    a: "Pause the bottom 20% if they're cannibalising budget from your top performers. But first try a feed-quality pass — many 'bad' SKUs are actually fine products with broken titles."
  },
  {
    q: "What's a healthy Google Shopping conversion rate?",
    a: "Highly category-dependent. Apparel: 1–2.5%. Electronics: 1.5–4%. Home: 2–5%. Beauty: 2.5–6%. If you're under 1% on non-apparel, something is structurally broken — usually one of the 7 above."
  }
]} />
