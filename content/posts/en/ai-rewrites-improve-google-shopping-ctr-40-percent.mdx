...
<FAQ>
  <FAQItem q="How long does it take to see the lift from AI rewrites?" a="Title and description changes typically show measurable CTR lift within 7 days as Google re-learns the relevance signal. Impressions volume restabilises in 10–14 days. Full ROAS impact is usually visible by day 21." />
  <FAQItem q="Will Google penalise me for changing my titles?" a="No, as long as the new title is more accurate, not more spammy. Stuffing keywords, hallucinating specs, or removing brand will trigger disapprovals. Adding genuinely missing attributes will not." />
  <FAQItem q="Do I need to keep regenerating rewrites over time?" a="Yes — but not constantly. Re-audit your top 200 SKUs every quarter, or whenever your search-term report shows a major new query cluster. Smaller stores can typically re-audit twice a year." />
  <FAQItem q="Can I just use ChatGPT for this myself?" a="You can, for one or two SKUs as a test. At catalog scale (200+ SKUs) you need attribute locking, diff review, category-aware prompts, and Merchant Center integration — none of which raw ChatGPT provides. That's the gap dedicated tools fill." />
</FAQ>
