...
description: "Un test de 90 jours dans trois secteurs révèle pourquoi la segmentation au niveau du flux offre 2 à 3 fois plus de contrôle et un CAC inférieur aux tactiques classiques de modificateurs d'enchères pour les campagnes Google Shopping à grande échelle."
keywords:
...
Consultez notre [guide de stratégie de libellés personnalisés](https://magicfeedpro.com/blog/custom-label-strategy) pour les règles de flux exactes que nous avons utilisées pour automatiser la segmentation selon la marge, la vélocité et le stade du cycle de vie.
...
Nous avons publié en open source nos modèles de libellés personnalisés et nos plans de structure de campagne dans la [bibliothèque d'études de cas MagicFeed Pro](https://magicfeedpro.com/case-studies)—prenez les Sheets, adaptez la logique et lancez votre propre test de 90 jours. Si les données ne bougent pas au jour trente, nous auditerons votre flux gratuitement.
