---
slug: "les-groupes-d-elements-performance-max-tuent-votre-flux-analyse-d-un-audit-a-200-000"
title: "Les Groupes d'Éléments Performance Max Tuent Votre Flux : Analyse d'un Audit à 200 000 $"
description: "PMax cannibalise les campagnes Shopping en promouvant les SKU à faible marge lorsque votre flux manque de hiérarchie product_type. Analyse forensique et corrections que la plupart des agences ratent."
keywords:
...
3. **Utilisation incohérente de `item_group_id`.** Si vous vendez des variantes (couleur, taille), toutes les variantes devraient partager un `item_group_id` et avoir des valeurs `id` uniques. Un [regroupement cassé](https://blog.magicfeedpro.com/fr/posts/variant-clustering-in-shopping-feeds-stop-cannibalizing-your-own-ads) amène PMax à traiter une chemise bleue et une chemise rouge comme des produits sans rapport, fracturant l'apprentissage.
...
Pour des conseils détaillés sur la stratégie de libellés personnalisés, consultez notre analyse sur [comment les marques DTC utilisent les libellés personnalisés pour contrôler les dépenses publicitaires](https://blog.magicfeedpro.com/fr/posts/custom-label-strategy-how-3-dtc-brands-scaled-to-8-figure-roas). Cet article inclut des modèles de schéma de libellés pour les produits d'abonnement, les bundles et les matrices marge-risque.
