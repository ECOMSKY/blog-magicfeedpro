...
coverAlt: "Um cartão de descrição de produto estruturada — renderizado como um retângulo isométrico alto — divide-se em duas colunas: coluna esquerda marcada com um ✗ carvão e barras violeta desbotadas (blocos de texto curtos e não estruturados), coluna direita marcada com um ✓ azul elétrico e linhas de atributos empilhadas nítidas (crachá de percentual, pequena seta, ponto em formato de estrela), com um painel AI Overview azul brilhante flutuando acima da coluna direita em diagonal ascendente."
---
