...
coverAlt: "Una scheda di descrizione prodotto strutturata — resa come rettangolo isometrico alto — si divide in due colonne: la colonna sinistra contrassegnata con una ✗ grigio scuro e barre viola sbiadite (blocchi di testo brevi non strutturati), la colonna destra contrassegnata con una ✓ blu elettrico e righe di attributi nitide impilate (un badge percentuale, una piccola freccia, un punto elenco a forma di stella), con un pannello AI Overview luminoso blu che galleggia sopra la colonna destra in diagonale verso l'alto."
---
